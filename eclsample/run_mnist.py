...
class Kings:
    ...
    train_mask_list = {
        ...
        "MELCHIOR": [False, False, True, True, True, False, False, False, False, False],
    ...
    train_mask_list = {
        "BALTHASAR": [True, True, True, True, True, True, True, True, True, True],
        "CASPER": [True, True, True, True, True, True, True, True, True, True],
        "MELCHIOR": [True, True, True, True, True, True, True, True, True, True],
        "KOUMEI": [True, True, True, True, True, True, True, True, True, True],
        "SHIBAI":[True, True, True, True, True, True, True, True, True, True]
    }
    '''
    ...
    def train(self, max_epoch=15, batch_size=200, test_interval=1):
        ...
        train_loader = torch.utils.data.DataLoader(train_set, batch_size=batch_size, sampler=sampler, num_workers=1)
        ...
        for epoch in range(max_epoch):   # loop over the dataset multiple times
            ...
            self.traintime=self.traintime+end_time-start_time
            
            if self.latest_epoch == 1 or self.latest_epoch % test_interval == 0:
                self.test()
            if self.latest_epoch == 14:
                print("train_time/iteration")
                print(self.traintime/14)
